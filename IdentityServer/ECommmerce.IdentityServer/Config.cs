    ...
    public static class Config
    {
        ...
        public static IEnumerable<IdentityResource> IdentityResources =>
                   new IdentityResource[]
                   {
                        ...
                        new IdentityResource(){Name = "roles", DisplayName = "Rol", Description = "Kullanıcı Rolleri", UserClaims = new[]{ "role"} }
                   };
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                ...
                new ApiScope("gateway_fullpermission","Order API için full erişim"),
