...
namespace ECommerceSite.Services.Catalog.DataAccess.Migrations
{
    ...
    [Migration("20240105140157_AddUpdateTimestampType")]
    partial class AddUpdateTimestampType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceSite.Services.Catalog.Models.Models.ProductStock", b =>
                {
                    b.Property<int>("ProductStorageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProductStorageId"));
            ...
            modelBuilder.Entity("ECommerceSite.Services.Catalog.Models.Models.ProductStock", b =>
                {
                    b.HasOne("ECommerceSite.Services.Catalog.Models.Models.Products", "Product")
            ...
            modelBuilder.Entity("ECommerceSite.Services.Catalog.Models.Models.Products", b =>
                {
                    b.HasOne("ECommerceSite.Services.Catalog.Models.Models.Categories", "Categories")
                        .WithMany("Products")
